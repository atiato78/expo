...
import UIExplorer from //   Description, // , {
//   Code,
//   DocFunctionItem,
//   AppText,
//   Section,
...
const stories = storiesOf('APIs', module);
  ...
  () => (
    <UIExplorer title={TITLE}>
      {/* <Description>
        ...
        alongside the source code of your app that the app needs at runtime. Examples include
        images, fonts and sounds. Expo's asset system integrates with React Native's, so that you
        can refer to files with <Code>require('path/to/file')</Code>. This is how you refer to
        static image files in React Native for use in an <Code>Image</Code> component, for example.
        Check out React Native's
        <AppText
        ...
        for more information. This method of referring to static image resources works out of the
        box with Expo.
      </Description>
