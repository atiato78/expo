...
import UIExplorer, { AppText, TextList, DocItem, Description, Code, Section } from '../ui-explorer';
              ...
              <TextList
                items={[
                  ...
                  <AppText>
                    ...
                    Updates.EventType.DOWNLOAD_FINISHED`, the manifest of the newly downloaded
                    update. Undefined otherwise.
                  </AppText>,
                  <AppText>
                    <Code>message (_string_)</Code>: -- If `type === Updates.EventType.ERROR`, the
                    error message. Undefined otherwise.
                  </AppText>,
                ]}
              />,
            ]}
...
import notes from './Updates.notes.md';
