...
public class ExpoFcmMessagingService extends FirebaseMessagingService {
  ...
  public void onMessageReceived(RemoteMessage remoteMessage) {
    ...
    try {
      JSONObject msg = new JSONObject(remoteMessage.getData().get("newFormat"));
      ...
      bundle.putString(NOTIFICATION_BODY, msg.getString(NOTIFICATION_BODY));
      ...
      bundle.putString(NOTIFICATION_DATA, msg.getString(NOTIFICATION_DATA));
